...
>
  ...
  <div style={{ marginBottom: '3rem' }}>
    ...
    <CardGroup cols={2}>
      <Card title="API Authentication" icon="key" href="/build-on-omnichain/evm-api/api-authentication">
  ...
  <div style={{ marginBottom: '3rem' }}>
    ...
    <CardGroup cols={2}>
      <Card title="Websocket API" icon="signal-stream" href="/build-on-omnichain/evm-api/websocket-api/introduction">
  ...
  <div style={{ marginBottom: '2.5rem' }}>
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Error Codes" icon="triangle-exclamation" href="/build-on-omnichain/evm-api/error-codes">
  ...
  >
    Quick links: <a href="/changelog/evm">Release Notes</a> ·{' '}
    <a href="/build-on-omnichain/overview">Contract Overview</a> ·{' '}
    <a href="/build-on-omnichain/addresses">Addresses</a> ·{' '}
    <a href="/build-on-omnichain/evm-api/websocket-api/introduction">Websocket API</a> ·{' '}
    <a href="/sdks/changelog">SDK Release Notes</a> ·{' '}
    <a href="/introduction/trade-on-orderly/supported-chains">Supported Chains</a>
  </div>
</div>
