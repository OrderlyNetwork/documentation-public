...
>
  ...
  >
    Quick links: <a href="/release-notes/omnichain">Release Notes</a> ·{' '}
    <a href="/build-on-omnichain/overview">Contract Overview</a> ·{' '}
    <a href="/build-on-omnichain/addresses">Addresses</a> ·{' '}
    <a href="/build-on-omnichain/websocket-api/introduction">Websocket API</a> ·{' '}
    <a href="/sdks/release-notes">SDK Release Notes</a> ·{' '}
