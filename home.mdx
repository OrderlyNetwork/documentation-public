...
>
  ...
  <div style={{ marginBottom: '3rem' }}>
    ...
    <CardGroup cols={2}>
      <Card title="Perp Anything" icon="chart-network" href="/introduction/trade-on-orderly/permissionless-listing">
      ...
      <Card title="Custom Oracle" icon="tower-broadcast" href="/introduction/trade-on-orderly/custom-oracle">
        Learn how builders can provide Custom Oracle feeds for Perp Anything markets, including private feeds, public feeds, and RWA market sessions.
      </Card>
    </CardGroup>
