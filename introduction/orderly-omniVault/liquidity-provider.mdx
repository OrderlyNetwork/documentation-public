...
description: "Learn how to deposit into and withdraw from Orderly OmniVault as a liquidity provider."
---
...
Orderly does not control the LayerZero protocol and is not responsible for delays, message failures,
or other issues related to cross-chain messaging.
