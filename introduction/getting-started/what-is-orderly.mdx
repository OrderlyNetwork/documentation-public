...
<img className="block dark:hidden" src="/images/preview_image.jpeg" alt="Orderly Preview Light" />
<img className="hidden dark:block" src="/images/preview_image.jpeg" alt="Orderly Preview Dark" />
