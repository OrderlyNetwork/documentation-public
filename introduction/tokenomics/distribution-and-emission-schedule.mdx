...
<img className="block dark:hidden" src="/images/order-tokenomics/emission-light.png" alt="Orderly Preview Light" />
<img className="hidden dark:block" src="/images/order-tokenomics/emission-dark.png" alt="Orderly Preview Dark" />
