...
Earn VALOR & USDC by staking \$ORDER/esORDER while enjoying stake boost for your earnings with [trading rewards](/introduction/tokenomics/trading-rewards/trading-rewards) and [market making rewards](/introduction/tokenomics/market-making-rewards/market-making-rewards)! Users have the flexibility to stake/unstake or claim their \$ORDER and \$USDC across the growing list of blockchain networks that Orderly supports, enjoying a seamless omnichain experience.
