---
title: "Staking"
description: "Follow this step-by-step guide to staking $ORDER or esORDER, managing unstaking, and claiming rewards."
---
...
- New system: _(Treasury pool value)_ ÷ _(Total circulating VALOR)_
- Legacy system: _(Treasury pool value)_ ÷ _(Total circulating VALOR)_ -- this ratio is fixed since no new revenue enters the legacy pool.
...
<Note>
  When redeeming VALOR, note which network you are connected to -- your rewards will be claimable on
  that network. This cannot be changed after the transaction is executed.
</Note>
