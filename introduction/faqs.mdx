...
<Accordion title="Can I list my token on Orderly?">
  Yes. If you want to list your token on Orderly, start here: [https://orderly.network/listing/](https://orderly.network/listing/).
</Accordion>
...
<Accordion title="What are the different order types?">
  **MARKET:** It matches until the full size is executed. If the size is too large (larger than the
  ...
  <Accordion title="How do you ensure no fake orders are settled on-chain?">
    All orders coming into the Orderly off-chain matching engine are signed by users' private trading keys and are settled on-chain with those signatures. Public keys are stored on the contract, and the signatures are verified to validate orders.
  ...
  <Accordion title="One of the DEXs I trade on is no longer operating, has been shut down, or operations have ceased. How do I close my positions and withdraw my funds?">
    If a DEX you trade on has shut down, ceased operations, or is no longer operating for whatever reason, you can use the **Emergency Exit** offboarding tool to quickly close all your open positions and withdraw your funds from Orderly Network.
