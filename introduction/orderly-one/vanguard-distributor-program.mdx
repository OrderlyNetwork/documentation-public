...
| Tier         | 30d Aggregate Volume | \$ORDER Staked | Base Taker Fee | Base Maker Fee | Tier Assignment Privilege   |
| :----------- | :------------------- | :------------- | :------------- | :------------- | :-------------------------- |
...
Distributors earn the "spread" between the invitee's base fee and their own. Base fees are tier-based Builder fees paid to Orderly, not the user-facing fees each Builder configures for its trading platform.
...
For maker orders, the negative tier rate is the maximum rebate Orderly will fund when a Builder sets a negative user-facing maker fee. The funded rebate is passed through to the trader and is not Builder revenue. If the user-facing maker fee is zero or positive, Orderly funds no maker rebate.
