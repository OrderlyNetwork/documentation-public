---
title: "Supplemental Terms for Front-End DEXes"
description: "Understand the supplemental legal terms for developers building and operating Front-End DEXes on Orderly."
sidebarTitle: "Supplemental Terms for Front-End DEXes"
---
...
These Supplemental Terms may be amended by Orderly at any time. Updates will be effective upon posting, in the manner set out in the Terms.

## 1. Independent Operation of Front-End DEXes

1.1 Each Front-End DEX is to be independently developed and operated by the developer or operator. Orderly does not own, control, monitor, sponsor, or endorse any Front-End DEX, and simply acts as a software solution for the Front-End DEX.
...
- Sanctions restrictions imposed by relevant authorities on certain users of the Front-End DEX;
...
1.3 Users of a Front-End DEX interact and trade on the Front-End DEX at their own risk. Orderly is not a party to those relationships and disclaims any liability arising from them.
...
2.3 Operators are solely responsible for ensuring that their Front-End DEX does not provide access to users located in restricted or sanctioned jurisdictions, including Cuba, Iran, North Korea, Syria, or any jurisdiction subject to comprehensive sanctions by the United Nations, United Kingdom or European Union. Orderly does not control, monitor, or approve the users of Front-End DEXes and disclaims all liability arising from access by restricted or sanctioned users.
...
2.5 Operators acknowledge that Orderly reserves the right, in its sole discretion, to restrict or terminate access to the DEX Service at any point in time, including without limitation, where Orderly determines a Front-End DEX:
...
3.4 Engage in conduct that may damage Orderly's reputation, expose Orderly to regulatory or legal risk, or undermine community trust.
...
4.2 Orderly does not guarantee security or uninterrupted availability of its services and disclaims liability for losses resulting from such events no matter how they arise.

4.3 Operators must implement appropriate safeguards in their own Front-End DEXes to protect themselves and their users.

4.4 Operators acknowledge and agree that each Front-End DEX is deployed, hosted, and operated using infrastructure, environments, and configurations that are not owned, controlled, or operated by Orderly (the "Operator-Controlled Components").

Operator-Controlled Components include, without limitation:

- domain names, subdomains, and any branded or custom URLs;
- DNS configuration, resolution services, and domain registrars;
- hosting environments, servers, cloud infrastructure, and storage systems;
- content delivery networks (CDNs), caching layers, and edge services;
- deployment pipelines, build systems, environment variables, and access controls;
- any modifications to, or forks of, Orderly-provided SDKs, templates, interfaces, or codebases; and
- any third-party services, integrations, scripts, libraries, or dependencies used in connection with a Front-End DEX.

Operators are solely responsible for the security, configuration, deployment, operation, monitoring, and maintenance of all Operator-Controlled Components, and for implementing appropriate technical and organisational safeguards to protect their Front-End DEX and its users.

Orderly does not control any Operator-Controlled Components and, to the maximum extent permitted by law, shall have no responsibility or liability for any loss, damage, exploit, phishing incident, misconfiguration, unauthorized access, service disruption, downtime, or other security or operational failure arising out of or in connection with any Operator-Controlled Components.

For the avoidance of doubt, this allocation of responsibility is consistent with, and in addition to, the disclaimers and limitations set out in the Terms.

## 5. Suspension and Termination

5.1 Access to Orderly's services, SDKs, liquidity, or infrastructure is a privilege provided at the discretion of Orderly.

5.2 Orderly may suspend or terminate a Front-End DEX's access, with or without notice, at any time in its sole and absolute discretion, including without limitation if:
...
Notwithstanding any other condition in the Terms, the Operators agree to indemnify and hold harmless Orderly and its affiliates, officers, employees, and agents from any claims, damages, losses, or liabilities (including reasonable legal fees) arising out of or related to:

- the Operator's operation of a Front-End DEX;
- any failure, vulnerability, or incident arising from Operator-Controlled Components;
