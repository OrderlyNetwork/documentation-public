...
| **…**               | …                                            | …                                                                                    |
| **$L_{N-1}$ user (direct referrer)** | $X_{N-1} + 10\%$ | $[X_{N-1} + 10\%] \times \text{(Fee)}_\text{Builder}$<br/>Direct referrer earns their full rate plus a 10% bonus (the $X_N$ portion goes to direct referrer instead of referee). |
