...
| ETH        | Arbitrum | 1,000                   |
| USDT       | Ethereum | 1,000,000               |
| ETH        | Ethereum | 500                     |
| ETH        | Base     | 500                     |
| USDT       | BSC      | 5,000,000               |
| YUSD       | Ethereum | 100,000                 |
| SOL        | SOL      | 40,000                  |
| BNB        | BSC      | 10,000                  |
| WBTC       | Ethereum | 80                      |
...
| Collateral | Minimum Swap Collateral Required (Arbitrum & Base) | Minimum Swap Collateral Required (Ethereum) | Minimum Swap Collateral Required (Solana) | Minimum Swap Collateral Required (BSC) |
| ---------- | -------------------------------------------------- | ------------------------------------------- | ----------------------------------------- | -------------------------------------- |
| USDT       | 50                                                 | 500                                         | 50                                        | 50                                     |
| ETH        | 0.02                                               | 0.2                                         | --                                        | --                                     |
| YUSD       | --                                                 | 500                                         | --                                        | --                                     |
...
| Collateral | Maximum Swap Collateral Threshold (Arbitrum & Base) | Maximum Swap Collateral Threshold (Ethereum) | Maximum Swap Collateral Threshold (Solana) | Maximum Swap Collateral Threshold (BSC) |
| ---------- | --------------------------------------------------- | -------------------------------------------- | ------------------------------------------ | --------------------------------------- |
