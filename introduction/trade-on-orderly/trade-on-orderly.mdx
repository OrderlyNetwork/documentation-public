...
description: "Get an overview of trading on Orderly Network, featuring shared liquidity and omnichain access."
---
...
<Card
  title="View all supported markets"
  icon="list"
  href="/introduction/trade-on-orderly/supported-markets"
/>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="chart-bar"
    href="/introduction/trade-on-orderly/trading-basics/orderbook-design"
  >
  ...
  <Card
    ...
    href="/introduction/trade-on-orderly/trading-basics/order-types"
  >
  ...
  <Card
    title="Trading Fees"
    icon="receipt"
    href="/introduction/trade-on-orderly/trading-basics/trading-fees"
  >
  ...
  <Card
    ...
    icon="coins"
    href="/introduction/trade-on-orderly/multi-collateral"
  >
...
<Card
  title="Independent perp volume benchmark"
  icon="chart-line-up"
  href="https://openchainbench.com/benchmarks/perp-volume-share"
>
  OpenChainBench ranks Orderly's 24h rolling notional volume alongside 14 other perp DEX venues,
  updated every 5 minutes from the public API. No sign-up required.
</Card>
