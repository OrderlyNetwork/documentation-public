...
Pre-TGE markets appear under a **Pre-launch** tab in the market list and show an extended risk disclosure before the first trade, noting that the token has not yet launched and that funding fee is not charged. During the pre-TGE phase, leverage is capped at 5x and no funding fee is collected.
