---
title: "Glossary"
description: "Review definitions of key trading terms used across Orderly, from order book to ADL."
---
...
**Maker Fee:** The fee or rebate applied when your order adds liquidity to the order book by waiting to be filled (e.g., a limit order that doesn't match right away). Builders set the user-facing maker fee. When that fee is negative, Orderly can fund the trader rebate up to the Builder's tier cap. The funded rebate is passed through to the trader and is not Builder revenue.
