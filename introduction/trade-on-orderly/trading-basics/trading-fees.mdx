...
### Fee types
**Maker fees:** Charged when your order adds liquidity to the order book -- for example, a limit order that doesn't fill right away. Currently, the **Orderly base maker fee is 0.00 bps** across all tiers.
