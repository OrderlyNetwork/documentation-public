...
- **Negative maker fees:** Builders at Silver tier and above receive maker rebates on qualifying orders. Trader rebates settle immediately on each execution; builder-side rebates are batched and settled once per day based on aggregated maker activity.
</Note>
