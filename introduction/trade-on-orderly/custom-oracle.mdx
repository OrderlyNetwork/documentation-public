...
Both Builder Oracle and BYOK Oracle can be used with supported real-world asset (RWA) markets. RWA support currently covers **US, Hong Kong (HK), China (CN), and Japan (JP) markets**, including stock and futures trading sessions.

Support for additional RWA market sessions is planned to be added gradually.
