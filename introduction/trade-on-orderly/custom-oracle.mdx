...
Custom Oracle lets Builders bring additional Index Price sources into [Permissionless Listing](/introduction/trade-on-orderly/permissionless-listing). It is designed for markets that need pricing beyond Orderly's standard CEX feeds and platform oracle sources.
