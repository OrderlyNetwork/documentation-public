...
Permissionless Vault is not a standalone feature -- it is a core component of Orderly Network's permissionless infrastructure, alongside [Perp Anything](/build-on-omnichain/perp-anything/introduction).
...
- [Perp Anything](/build-on-omnichain/perp-anything/introduction)
