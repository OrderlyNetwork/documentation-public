...
description: "Learn how Orderly computes Mark Price, Index Price, and Last Price with manipulation safeguards."
---
...
Because no single exchange should have the power to move this price on its own, Orderly applies several safeguards to prevent manipulation, outages, or connectivity problems from distorting the Index Price:
...
| Symbol   | Binance | OKX | Huobi | Gateio | Bybit | Kucoin | MEXC | Bitget | BingX | LBank |
| -------- | ------- | --- | ----- | ------ | ----- | ------ | ---- | ------ | ----- | ----- |
| 1000BONK | X       | X   |       | X      | X     | X      | X    | X      |       |       |
| 1000PEPE | X       | X   |       | X      | X     | X      |      |        |       |       |
| 1000SHIB | X       | X   |       | X      | X     | X      | X    | X      |       |       |
| AAVE     | X       | X   |       | X      | X     | X      | X    |        |       |       |
| ADA      | X       | X   |       | X      | X     | X      | X    | X      |       |       |
| APT      | X       | X   |       | X      | X     | X      |      |        |       |       |
| ARB      | X       | X   |       | X      | X     | X      | X    | X      |       |       |
...
<Note>
  Some symbols (M, BZ, CL, LIT, SPX, XAU, XAG) additionally include perp-derived index sources
  (`binancefuturesindex`, `hyperliquidperp`) that are not shown in the spot exchange table above.
</Note>

| RWA    | Pyth | Finage | Trademade | Chainlink | Hyperliquid Perp | Binance Futures Index |
| ------ | ---- | ------ | --------- | --------- | ---------------- | --------------------- |
| SPX500 |      | X      | X         |           | X                |                       |
| NAS100 |      | X      | X         |           | X                |                       |
| XAU    | X    |        |           |           | X                | X                     |
...
| Asset Class     | Symbols                                            | ON_MARKET Factor | OFF_MARKET Factor | ON_MARKET Max Deviation | OFF_MARKET Max Deviation |
| --------------- | -------------------------------------------------- | ---------------- | ----------------- | ----------------------- | ------------------------ |
| Equity / Energy | SPX500, NAS100, NVDA, TSLA, GOOGL, CL, BZ          | 1.5              | 7.5               | 0.3%                    | 1.5%                     |
| Metals          | XAU, XAG                                           | 2                | 10                | 0.2%                    | 1.0%                     |
| FX              | EURUSD, USDJPY                                     | 1.5              | 7.5               | 0.3%                    | 1.5%                     |
