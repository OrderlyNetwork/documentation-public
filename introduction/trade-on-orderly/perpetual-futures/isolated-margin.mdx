...
For markets that support both modes, traders can choose either Cross Margin or Isolated Margin when placing orders. Perp Anything markets are the exception and should be treated as Isolated Margin only.

### Multi-collateral support

Eligible collateral assets can support isolated-margin trading, including accounts that hold supported non-USDC collateral. Isolated margin remains denominated and accounted for in USDC. See [Multi-Collateral](/introduction/trade-on-orderly/multi-collateral) for supported collateral assets and applicable limits.

When projected USDC borrowing from opening an isolated-margin position exceeds the **50,000 USDC** limit, automatic conversion of collateral into USDC is triggered to reduce the borrowing amount.

## Related Pages

- [Margin, Leverage & PnL](/introduction/trade-on-orderly/perpetual-futures/margin-leverage-and-pnl) -- how margin ratios, leverage tiers, and PnL work
- [Liquidations](/introduction/trade-on-orderly/perpetual-futures/liquidations) -- how the liquidation process is triggered and handled
