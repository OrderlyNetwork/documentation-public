...
description: "How to integrate wallet connection with the Orderly React SDK using WalletConnectorContext."
---
...
- `customChains` (**optional**) – Builders can define which chains to display.
...
After defining the component, you also need to add this component to the parent of [`OrderlyAppProvider`](/sdks/react/getting_started#add-a-global-configuration-provider).
