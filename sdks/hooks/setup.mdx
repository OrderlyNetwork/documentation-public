---
title: "Setup"
description: "How to install, configure, and connect wallet adapters with the Orderly React hooks SDK."
---
...
We recommend that you use the default config in the newly created project and provide your own `brokerId`. Start from the [broker onboarding guide](/introduction/getting-started/broker-onboarding) to set up your builder identity. If you are using Orderly One, continue from [https://dex.orderly.network/](https://dex.orderly.network/).
