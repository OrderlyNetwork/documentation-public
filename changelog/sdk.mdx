...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **Internal Transfers via Account ID**
      - Enable users to perform internal transfers by withdrawing directly to another Orderly account using the account_id.
    </div>
  </div>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **UI/UX Enhancements**
      ...
      - Updated the default order size decimals for better clarity:
        - BTC: 1 decimal place
        - ETH: 0.1 decimal place
      - Funding Comparison: Open Interest Added
      - Language Selector in MWeb Navigation Bar
      - One-Click Network Switch from Wallet Prompt: Users can now quickly switch networks directly from the wallet prompt message when needed.
    </div>
  </div>
