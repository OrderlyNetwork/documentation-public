...
**Weight:** `20` — this is the heaviest endpoint (broadcast scan across 128 shards). Use sparingly.
...
| `opened_at` | int64 \| null | Batched `IN`-lookup of `position_history_detail` (avoids N+1) |
