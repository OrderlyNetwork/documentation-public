...
Open and partially-filled orders for an address. Unions ordinary orders (parent_order_id = 0) and algo orders (parent_algo_order_id = 0); merged and sorted in memory.
