...
<Accordion title="How are fees managed?">
  ...
  default fee rate and, if needed, apply custom fee logic for specific users. Use [Fee Settings in
  Orderly One](https://dex.orderly.network/fee-settings), and see [Custom
...
If you register through the broker registration tool, use the same creator wallet or designated
...
[Builder Onboarding](/introduction/getting-started/builder-onboarding), [Custom
Fees](/build-on-omnichain/user-flows/custom-fees), and [API
Authentication](/build-on-omnichain/api-authentication).
