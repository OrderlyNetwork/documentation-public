...
If `margin_mode` is omitted, the symbol's default margin mode is used. You can change the default via [POST `/v1/client/margin_mode`](/build-on-omnichain/restful-api/private/update-margin-mode).
