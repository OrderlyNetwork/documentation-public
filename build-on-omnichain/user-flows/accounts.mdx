---
title: "Accounts"
description: "Learn how to register user accounts, manage account states, and map wallets to builders on Orderly."
---
...
jsonBody.put("signature", signatureToHashString(signature));
...
After successfully registering your account, you must enable authentication by binding an Orderly Key. Proceed to the next step:

- [Wallet Authentication (Orderly Key)](/build-on-omnichain/user-flows/wallet-authentication)

> [!WARNING]
> If you do not bind an Orderly Key to your account, you will not be able to access any private REST APIs or subscribe to private WebSocket streams.
