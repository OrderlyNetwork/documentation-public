...
<Note>
  RWA support currently covers US, Hong Kong (HK), China (CN), and Japan (JP) market sessions,
  including stock and futures hours. Support for additional market sessions is planned to be added
  gradually.
</Note>
