...
> This page explains **Direct Transfer Deposit** (via Exclusive Receiver Address), which is ideal for custodial wallets, centralized exchange (CEX) withdrawals, or automated bots.
> If your users can connect their Web3 wallets to your DApp and sign transactions, we recommend using the faster [Standard Vault Deposit](/build-on-omnichain/user-flows/withdrawal-deposit) guide.
