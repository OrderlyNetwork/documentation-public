...
<Note>
  All endpoints below are **private** and require standard [Orderly authentication headers](/build-on-omnichain/api-authentication) (`orderly-account-id`, `orderly-key`, `orderly-signature`, `orderly-timestamp`).
</Note>
