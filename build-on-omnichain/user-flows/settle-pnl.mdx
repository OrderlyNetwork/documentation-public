...
| settleNonce | int       | Y            | Valid withdrawal nonce from [Get settle PnL nonce](/build-on-omnichain/restful-api/private/get-settle-pnl-nonce)           |
| timestamp   | timestamp | Y            | current timestamp in UNIX milliseconds                       |

  </Step>
  <Step title="Request PnL settlement">
    Request a PnL settlement through [Request Pnl settlement API](/build-on-omnichain/restful-api/private/request-pnl-settlement).
  </Step>
</Steps>
