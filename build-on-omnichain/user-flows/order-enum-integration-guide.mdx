...
<Steps>
  <Step title="Create order tags">
    ...
    Use [POST `/v1/broker/order_enum`](/build-on-omnichain/restful-api/private/create-order-tag).
  ...
  <Step title="Expose active order tags to your DEX">
    ...
    Use [GET `/v1/public/broker/order_enums`](/build-on-omnichain/restful-api/public/list-order-tags-for-a-broker).
...
Use [GET `/v1/public/broker/order_enums`](/build-on-omnichain/restful-api/public/list-order-tags-for-a-broker) from your DEX or backend service to discover available order tag fee configs for a builder.
...
| ------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| Create order tag                      | [POST `/v1/broker/order_enum`](/build-on-omnichain/restful-api/private/create-order-tag)                        |
| Update order tag                      | [PUT `/v1/broker/order_enum/{enum_id}`](/build-on-omnichain/restful-api/private/update-order-tag)               |
| List order tags with usage stats      | [GET `/v1/broker/order_enums`](/build-on-omnichain/restful-api/private/list-all-order-tags-for-a-builder)       |
| Get single order tag with usage stats | [GET `/v1/broker/order_enum/{enum_id}`](/build-on-omnichain/restful-api/private/get-single-order-tag-with-stats) |
| Archive order tag                     | [POST `/v1/broker/order_enum/archive`](/build-on-omnichain/restful-api/private/archive-an-order-tag)            |
| Unarchive order tag                   | [POST `/v1/broker/order_enum/unarchive`](/build-on-omnichain/restful-api/private/unarchive-an-order-tag)        |
