...
2. Fill **`.orderly-manifest.json`** with **`pluginId`**, optional **`usagePrompt`**, **`tags`** (≤5, [valid values](/build-on-omnichain/builder-marketplace/manifest-and-submit#valid-builder-marketplace-tags)).
