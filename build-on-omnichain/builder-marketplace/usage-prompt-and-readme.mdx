...
## `usagePrompt` (Builder Marketplace / manifest)
...
The README is **not** uploaded to the Builder Marketplace API, but it is the human-facing home for your repo. Suggested structure:
