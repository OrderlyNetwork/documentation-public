...
An RWA market can use supported exchange feeds (CEX/DEX), platform oracle sources, Builder-pushed feeds, or Bring Your Own Key sources when those sources are available for the asset.
