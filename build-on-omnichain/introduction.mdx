---
title: "Introduction"
description: "Orderly EVM API overview covering REST and WebSocket endpoints, authentication, and request conventions."
---
...
Please set the corresponding header in your request. Please refer to [API authentication](/build-on-omnichain/api-authentication) for more information.
...
Specific error codes and messages are defined in [Error Codes](/build-on-omnichain/error-codes).
