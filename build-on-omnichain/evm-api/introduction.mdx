...
Please set the corresponding header in your request. Please refer to [API authentication](/build-on-evm/evm-api/api-authentication) for more information.
...
Specific error codes and messages are defined in [Error Codes](/build-on-evm/evm-api/error-codes).
