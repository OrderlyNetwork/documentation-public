...
- You must use a path that exists in [Runtime injector targets](/build-on-omnichain/module-marketplace/runtime-injector-targets).
...
- [Interceptor strategies](/build-on-omnichain/module-marketplace/interceptor-strategies)
- [Tutorial: First plugin](/build-on-omnichain/module-marketplace/first-plugin)
