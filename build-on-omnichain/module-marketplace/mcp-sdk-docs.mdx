...
There is **no** `orderly_docs_get_hook` — use **`orderly_docs_search`** plus **`orderly_docs_get_component`** / **`orderly_docs_get_type`** ([alignment](/build-on-omnichain/module-marketplace/agent-skills-alignment)).
