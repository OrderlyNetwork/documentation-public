...
- **Builder setup:** Start from [Builder Onboarding](/introduction/getting-started/builder-onboarding). If you are using Orderly One, complete the graduation flow on the [Orderly One portal](https://dex.orderly.network/dex) to create your builder ID and continue onboarding.
