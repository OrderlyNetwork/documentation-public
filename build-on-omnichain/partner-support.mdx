...
- **Builder setup:** Start from [Builder Onboarding](/introduction/getting-started/builder-onboarding). All builders should sign up on [Orderly One](https://dex.orderly.network/) and complete the setup/graduation flow to create their builder profile and obtain their broker ID. Orderly One serves as the builder portal for both low-code and SDK/API builders. Low-code builders will create a DEX frontend through Orderly One; SDK/API builders do not need to create a DEX frontend. The graduation fee is **$10** for both launch paths.
