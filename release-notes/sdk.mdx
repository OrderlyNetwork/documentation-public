...
<div style={{ display: "table", width: "100%" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **Bug Fixes** - Fixed PML symbol funding rate modal on mobile showing empty values for
      Interval, Funding cap/floor, and Estimated funding fee
    </div>
  </div>
</div>

## April 30, 2026 - v3.0.2
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **Features & Improvements**
      ...
      - **Permissionless Listed Symbols Support** — The SDK now fully supports permissionlessly listed symbols, with proper UI rendering and trading support aligned with the platform-wide rollout
