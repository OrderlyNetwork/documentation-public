...
<div style={{ display: "table", width: "100%" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **Features & Improvements**
      - Isolated Margin — Added isolated margin mode, allowing traders to allocate specific margin to individual positions for better risk management
    </div>
  </div>
</div>
...
<div style={{ display: "table", width: "100%" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **Features**
      - Introduce the new affiliate program (multilevel structure)
      - Add tooltip to clarify specific withdrawal limitations
    </div>
  </div>
</div>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **New Features**
      ...
      - Order Book Precision Control: Builders can now configure the default number of decimals displayed on the order book per symbol.
      - Customizable Header Navigation: Builders can now configure custom header navigation items to better tailor the interface to their needs.
    </div>
  </div>
</div>
