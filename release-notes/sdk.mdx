...
<div style={{ display: "table", width: "100%" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      **Features & Improvements**
      - Updated the wallet registration request to align with the latest backend API.
...
<div style={{ display: "table", width: "100%" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      **Bug Fixes**
      - Fixed PML symbol funding rate modal on mobile showing empty values for Interval, Funding cap/floor, and Estimated funding fee.
...
<div style={{ display: "table", width: "100%" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      **Features & Improvements**
      - **Plugin Developer Toolchain** — Improvements to orderly-devkit CLI, plugin agent skills, and SDK Docs MCP server.
...
<div style={{ display: "table", width: "100%" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      **Features & Improvements**
      - **Plugin System** — SDK v3 introduces the plugin system, enabling builders to develop, share, and install custom modules on top of the Orderly trading interface. Plugins register interceptors at specific target paths in the SDK's rendering pipeline to enhance, wrap, or replace existing components. See the [Builder Marketplace](/build-on-omnichain/builder-marketplace/introduction) for details.
