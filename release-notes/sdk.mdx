---
title: TS SDK
description: "Release notes for the TypeScript SDK"
icon: "layer-group"
---

import { Chip } from "/snippets/chip.mdx";

## Aug 17th, 2026 - v3.1.9
...
<div style={{ display: "table", width: "100%" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **Bug Fixes**
      - **Wallet component compatibility** — Fixed compatibility issues for builders who have not enabled or configured a Privy wallet integration
    </div>
  </div>
</div>

## Jul 16th, 2026 - v3.1.6
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      **Features & Improvements**
      - **Affiliate-defined referral codes** — Affiliates can now define their own referral code when creating one
    </div>
  </div>
</div>
