...
## Sep 6th, 2026 (Scheduled Maintenance)
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      - Downtime: Mainnet services will be unavailable during this maintenance window
    </div>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      - **Multi-collateral support in isolated margin:** Eligible collateral assets can now support isolated-margin trading, including accounts that hold supported non-USDC collateral. Isolated margin remains denominated and accounted for in USDC. If opening a position would cause the USDC borrowing amount to exceed 50,000 USDC, automatic collateral conversion is triggered to reduce the borrowing amount
    </div>
